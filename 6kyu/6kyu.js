...
function checkInteger(num) {
  ...
  if ((num % 3 === 0 || (num % 3 === 0 && num % 4 === 0)) && num % 2 === 0) {
    result += "Script";
  }
...
// Examples
console.log(checkInteger(1));   // "mocha_missing!"
console.log(checkInteger(3));   // "Java"
console.log(checkInteger(6));   // "JavaScript"
console.log(checkInteger(12));  // "CoffeeScript"
...
// Example usage:
console.log(longestVowelSubstring("codewarriors")); // Outp